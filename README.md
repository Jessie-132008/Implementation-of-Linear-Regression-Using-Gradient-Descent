...
## Algorithm
1. Generate multivariate sataset and split into training and testing sets. 
2. Scale features using StandardScaler for better SGD performance.
3. Train the SDG Regressor on training data. 
...
## Output:
<img width="733" height="545" alt="image" src="https://github.com/user-attachments/assets/48e739bb-a47f-453f-bde6-507f0b2e970c" />
